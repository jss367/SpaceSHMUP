...
public class Main : MonoBehaviour {
	...
	public WeaponType[]			powerUpFrequency = new WeaponType[] {
				...
				WeaponType.spread,
				WeaponType.shield
		}; // Not sure what WeaponType.blaster is there twice. This might be an error. Check if something is missing
	//Unlikely to be an error because he has a screen capture of this too.
